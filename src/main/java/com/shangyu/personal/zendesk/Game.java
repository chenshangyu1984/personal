...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        // size of game
        int sizeOfGame = GameUtils.getSizeOfGame(scanner,
                "Enter size of game (at least " +
                        Board.WINNER_LEN + "): ");
        Board board = new Board(sizeOfGame);

        // name of player 1
        String player1Name = GameUtils.getNameOfPlayer(scanner,
                "Enter name for Player 1: ");
        Player player1 = new Player(player1Name, Board.MARKER_X);

        // name of player 2
        String player2Name = GameUtils.getNameOfPlayer(scanner,
